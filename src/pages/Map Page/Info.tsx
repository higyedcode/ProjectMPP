            ...
            <div>
                ...
                {drag?.dragStart && drag?.dragEnd && (
                    <>
                        ...
                        <p>
                            {drag.dragStart
                                ? `lat: ${drag.dragStart.lat}, lng: ${drag.dragStart.lng}`
                                : 'null'}
                        </p>
                        <p>Dragging:</p>
                        <p>
                            {drag.dragging
                                ? `lat: ${drag.dragging.lat}, lng: ${drag.dragging.lng}`
                                : 'null'}
                        </p>
                        <p>Drag end:</p>
                        <p>
                            {drag.dragEnd
                                ? `lat: ${drag.dragEnd.lat}, lng: ${drag.dragEnd.lng}`
                                : 'null'}
                        </p>
                    </>
                )}
            ...
            <div className={styles.bounds}>
                ...
                <div>
                    {bounds?.map((bound: number, index: number) => {
                        const name = ['SW lng', 'SW lat', 'NE lng', 'NE lat'][
                            index
                        ]
                        // eslint-disable-next-line react/no-array-index-key
